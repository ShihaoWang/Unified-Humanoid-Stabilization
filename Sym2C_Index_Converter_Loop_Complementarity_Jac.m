function [iGfunjGvar_Total, Gsym_Total, row_no] = Sym2C_Index_Converter_Loop_Complementarity_Jac(Symbol_Exp, Current_Constraint_Number, Current_Jacobian_Number)
...
for i = 1:row_no
    ...
    iGfunjGvar_Total = [iGfunjGvar_Total iGfun iGfn_index ' + i * (grids_per_segment - 1) * 12 + 12 * j ' ij_end ];
