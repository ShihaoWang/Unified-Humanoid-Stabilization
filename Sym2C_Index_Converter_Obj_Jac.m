function [iGfunjGvar_Total, Gsym_Total, row_no] = Sym2C_Index_Converter_Obj_Jac(Symbol_Exp, Current_Constraint_Number, Current_Jacobian_Number)
...
Fsym_Total = strrep(Fsym_Total,'rIx_4_10','x[4 * 48 * 10 + 9 * 48]');
Fsym_Total = strrep(Fsym_Total,'rIy_4_10','x[4 * 48 * 10 + 9 * 48 + 1]');
Fsym_Total = strrep(Fsym_Total,'theta_4_10','x[4 * 48 * 10 + 9 * 48 + 2]');
Fsym_Total = strrep(Fsym_Total,'q1_4_10','x[4 * 48 * 10 + 9 * 48 + 3]');
Fsym_Total = strrep(Fsym_Total,'q2_4_10','x[4 * 48 * 10 + 9 * 48 + 4]');
Fsym_Total = strrep(Fsym_Total,'q3_4_10','x[4 * 48 * 10 + 9 * 48 + 5]');
Fsym_Total = strrep(Fsym_Total,'q4_4_10','x[4 * 48 * 10 + 9 * 48 + 6]');
Fsym_Total = strrep(Fsym_Total,'q5_4_10','x[4 * 48 * 10 + 9 * 48 + 7]');
Fsym_Total = strrep(Fsym_Total,'q6_4_10','x[4 * 48 * 10 + 9 * 48 + 8]');
Fsym_Total = strrep(Fsym_Total,'q7_4_10','x[4 * 48 * 10 + 9 * 48 + 9]');
Fsym_Total = strrep(Fsym_Total,'q8_4_10','x[4 * 48 * 10 + 9 * 48 + 10]');
Fsym_Total = strrep(Fsym_Total,'q9_4_10','x[4 * 48 * 10 + 9 * 48 + 11]');
Fsym_Total = strrep(Fsym_Total,'q10_4_10','x[4 * 48 * 10 + 9 * 48 + 12]');

Fsym_Total = strrep(Fsym_Total,'rIxdot_4_10','x[4 * 48 * 10 + 9 * 48 + 13]');
Fsym_Total = strrep(Fsym_Total,'rIydot_4_10','x[4 * 48 * 10 + 9 * 48 + 14]');
Fsym_Total = strrep(Fsym_Total,'thetadot_4_10','x[4 * 48 * 10 + 9 * 48 + 15]');
Fsym_Total = strrep(Fsym_Total,'q1dot_4_10','x[4 * 48 * 10 + 9 * 48 + 16]');
Fsym_Total = strrep(Fsym_Total,'q2dot_4_10','x[4 * 48 * 10 + 9 * 48 + 17]');
Fsym_Total = strrep(Fsym_Total,'q3dot_4_10','x[4 * 48 * 10 + 9 * 48 + 18]');
Fsym_Total = strrep(Fsym_Total,'q4dot_4_10','x[4 * 48 * 10 + 9 * 48 + 19]');
Fsym_Total = strrep(Fsym_Total,'q5dot_4_10','x[4 * 48 * 10 + 9 * 48 + 20]');
Fsym_Total = strrep(Fsym_Total,'q6dot_4_10','x[4 * 48 * 10 + 9 * 48 + 21]');
Fsym_Total = strrep(Fsym_Total,'q7dot_4_10','x[4 * 48 * 10 + 9 * 48 + 22]');
Fsym_Total = strrep(Fsym_Total,'q8dot_4_10','x[4 * 48 * 10 + 9 * 48 + 23]');
Fsym_Total = strrep(Fsym_Total,'q9dot_4_10','x[4 * 48 * 10 + 9 * 48 + 24]');
Fsym_Total = strrep(Fsym_Total,'q10dot_4_10','x[4 * 48 * 10 + 9 * 48 + 25]');
